...
# hence the x-coordinates of start and end of the diameter suffice. Start is always smaller than end. There will be at most 104 balloons.
#
...
class Solution:
    def findMinArrowShots(self, points):
        ...
        for i in range(1, len(points)):
            if not (points[i][0] <= result[-1] <= points[i][1]):
